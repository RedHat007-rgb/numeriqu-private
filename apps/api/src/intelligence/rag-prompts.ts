 ...
 */
export {
  ADVISOR_PROMPT as RAG_SYSTEM_PROMPT,
  buildFactBlock as SCHEMA_CONTEXT_INJECTOR,
} from './prompt-builder';

export const ERROR_MESSAGES = {
  OLLAMA_OFFLINE:
    'Intelligence engine warming up. Showing live ClickHouse metrics.',
  MODEL_NOT_FOUND: 'Optimizing reasoning models. One moment...',
  GENERIC_ERROR:
    'Slight delay synthesizing strategy. Showing verified ledger data...',
};
