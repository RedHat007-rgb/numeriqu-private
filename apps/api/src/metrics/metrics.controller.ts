import { Controller, Get, Req, Res, Query, UseGuards, UnauthorizedException, InternalServerErrorException } from '@nestjs/common';
...
export class MetricsController {
  ...
  async downloadXero(
    ...
    const filename = resource ? `xero_${resource}_export.csv` : 'xero_full_export.csv';
